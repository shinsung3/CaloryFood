...
public class Food {
	...
	public Food(int code, String name, String maker, String material,String image, double supportpereat, double calory, double carbo, double protein, double fat,
			double sugar, double natrium, double chole, double fattyacid, double transfat) {
		super();
		this.code = code;
		this.name = name;
	...
	public String toString() {
		return code+",'"+name+"','"+maker+"','"+material+"','"+image+"',"+supportpereat+","+calory+","+carbo+","+protein+","+fat+","+sugar+","+natrium+","+chole+","+fattyacid+","+transfat+"\n";
	}
